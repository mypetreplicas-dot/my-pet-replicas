...
export default function SanAntonioPage() {
    return (
        <>
                    ...
                    <div className="relative z-10 max-w-6xl mx-auto px-6">
                        <div className="max-w-2xl space-y-10">
                            ...
                            <p className="text-lg md:text-xl text-neutral-400 leading-relaxed max-w-lg">
                                Hand-painted in San Antonio to capture every marking, expression, and detail that makes your pet yours. Beautifully crafted to keep them close, forever.
                            </p>
                    ...
                    <HomeFadeUp>
                        <div className="text-center mb-16">
                            ...
                            <p className="text-sm text-neutral-500">
                                5-star rated · 1,000+ custom figures hand-painted on Etsy
                            </p>
                        </div>
                    </HomeFadeUp>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
                        {reviews.map((review, i) => (
                            <HomeFadeUp key={i} delay={i * 0.15}>
                                <div className="bg-[var(--color-dark-card)] rounded-2xl p-8 md:p-10 shadow-lg">
            ...
            {/* ── How It Works (Local) ── */}
            <section className="py-24 md:py-32 px-6 bg-[var(--color-dark-card)]">
                <div className="max-w-6xl mx-auto">
                    <HomeFadeUp>
                        <h2 className="font-display text-3xl md:text-4xl font-bold text-white text-center mb-20">
                        ...
                        {[
                            ...
                            <HomeFadeUp key={i} delay={i * 0.15}>
                                <div className="text-center group">
                                    <div className="mx-auto w-16 h-16 rounded-full bg-terra-600/10 text-terra-400 flex items-center justify-center mb-6 group-hover:bg-terra-600/20 group-hover:scale-110 transition-all duration-300">
                                        {item.icon}
                                    </div>
